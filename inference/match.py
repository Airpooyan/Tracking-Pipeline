...
if __name__ == '__main__':
	tracks = [[0,0,10,10],[2,23,40,50],[2,2,22,22]]
	detections = [[1,1,10,10],[2,23,45,55],[2,2,22,22]]
	matcher = Matcher()
	matchs, unmatch1, unmatch2 = matcher.associate_detections_to_trackers_iou(detections, tracks, iou_threshold = 0.5)
	print(matchs)
	print(unmatch1)
	print(unmatch2)