...
import _init_paths
from pose.core.config import config
from pose.core.config import update_config
from pose.core.config import update_dir
from pose.core.loss import JointsMSELoss
from pose.core.function import validate
...
def parse_args():
    ...
    parser.add_argument('--cfg',
                        ...
                        required=False,
                        default='/export/home/zby/SiamFC/data/pose_res152.yaml',
                        type=str)
    ...
    parser.add_argument('--model-file',
                        ...
                        default='data/models/model_99.pth.tar',
                        type=str)
