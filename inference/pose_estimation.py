...
class PoseNet:
	def __init__(self, gpu_id=0, model_path='/export/home/zby/SiamFC/data/models/model_99.pth.tar'):
		...
		with torch.cuda.device(self.gpu_id):
			...
			#logger, final_output_dir, tb_log_dir = create_logger(cfg, cfg_file, 'valid')
	...
	def detect_pose(self, im, bbox):
		...
		#print(heatmaps.shape,preds,maxvals)
...
if __name__ == '__main__':
	...
	pose_net = PoseNet()
	preds, maxvals, heatmaps = pose_net.detect_pose(im, bbox)
	print(bbox,preds)
	for pred in preds:
		x,y = pred
