...
from pose.utils.transforms import affine_transform
from pose.utils.transforms import fliplr_joints
...
class JointsDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        im_bbox=np.array(db_rec['bbox']) if 'bbox' in db_rec else np.array([0,0,0,0])
        #print(im_bbox)
