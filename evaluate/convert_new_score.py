...
if args.test_dir == None:
	test_filedir = 'detection_iou_embedding'
else:
...
save_dir = '/export/home/zby/SiamFC/data/posetrack/{}_newScore_{}_{}'.format(test_filedir, pose_number_thresh, pose_vis_thresh)
