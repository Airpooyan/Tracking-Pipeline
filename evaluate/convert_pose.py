...
if args.test_dir == None:
	test_filedir = 'detection_iou_embedding_det0.3_oks0.8_effectiveDet0.3'
else:
...
txt.write('--------------------------------------\n')
txt.write('TestMethod: {} PoseVisThresh: {} PoseVisNumber: {}\n'.format(test_filedir, pose_vis_thresh, pose_number_thresh))

pbar = tqdm(range(len(json_files)))
save_dir = '/export/home/zby/SiamFC/data/posetrack/{}_{}_{}'.format(test_filedir, pose_number_thresh, pose_vis_thresh)
